...
class StudentPortal(CustomerPortal):
    ...
    def student_portal(self):
        ...
        return request.render("ala_website.student_portal")
    ...
    def student_info(self):
        ...
        return request.render("ala_website.student_info",
                              {'values': vals})
    ...
    def student_exam_result(self):
        ...
        return request.render(
            "ala_website.student_exam_result",
            {'data': exam})
    ...
    def exam_subject(self):
        ...
        return request.render(
            "ala_website.student_result", data)
