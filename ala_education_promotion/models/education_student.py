...
class EducationStudentFinalResult(models.Model):
    """
       ...
       """
    _name = 'ala.education.student.final.result'
    ...
    division_id = fields.Many2one('ala.education.class.division', string="Class",
    ...
    academic_year_id = fields.Many2one('ala.education.academic.year',
                                       ...
                                       help='Represents the academic year '
                                            ...
                                            'was recorded.')
    closing_id = fields.Many2one('ala.education.promotion',
                                 string='Academic Year',
